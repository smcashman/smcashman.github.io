...
<body>
	...
	<!-- Start BlockQuote -->
	<div class="blockquote main" id="about">
		<blockquote> I'm a web developer in <b>Boston</b>. I love clean design, old books, and art.</blockquote>
	</div>
	<!-- End BlockQuote -->
	...
	<div class="content">
		...
		<div class="section divider"   id="projectsection">
		<h2 id="servicestitle">Recent Projects</h2>
			...
			<ul class="carousel" id="carousellatest">
				...
				<li>
					<div class="section block">	
						<img src="img/pantryscreenshot.png">
						<div class="content">
							<h5>Shopping List</h5>
							<h6>Design, HTML, CSS, JQuery</h6>
						</div>
						<div class="hover">
							<a href="https://smcashman.github.io/pantry/" class="hover content" target='blank'>
								<h2>+</h2>
								<h5>Shopping List</h5>
								<h6>Design, HTML, CSS, JQuery</h6>
							</a>
				...
				<li>
					<div class="section block">	
						<img src="img/tictactoescreenshot.png">
						<div class="content">
							<h5>Tic Tac Toe</h5>
							<h6>Retro styling with JQuery for functionality</h6>
						</div>
						<div class="hover">
							<a href="https://smcashman.github.io/tictactoe/" class="hover content" target="blank">
								<h2>+</h2>
								<h5>Tic Tac Toe</h5>
								<h6>Retro styling with JQuery for functionality</h6>
							</a>
				...
				<li>
					<div class="section block">	
						<img src="img/artquizscreenshot.png">
						<div class="content">
							<h5>Art Quiz</h5>
							<h6>HTML, CSS, Jquery</h6>
						</div>
						<div class="hover">
							<a href="https://smcashman.github.io/artquiz/" class="hover content" target="blank">
								<h2>+</h2>
								<h5>Art Quiz</h5>
								<h6>HTML, CSS, Jquery</h6>
							</a>
				...
				<li>
					<div class="section block">	
						<img src="img/bookshelfshot.png">
						<div class="content">
							<h5>Bookshelf</h5>
							<h6>Node.js & Express</h6>
						</div>
						<div class="hover">
							<a href="http://whispering-beyond-60086.herokuapp.com/users/login" class="hover content">
								<h2>+</h2>
								<h5>Bookshelf</h5>
								<h6>Node.js & Express</h6>
							</a>
	...
	<div class="section divider"   id="skillsection">
		<h2 id="servicestitle">Skills & Languages</h2>
		<a class="scroll" id="services"></a>
	</div>
	<!-- End Section Divider -->
	...
	<div class="content">
		...
		<p class="main dark-gray" id="services">Hover to find out more</p>
		<!-- Start Main Paragraph -->

		<div class="servicesitem">
			<div class="front">
				<div data-icon="&#xe055;" class="icon"></div>
				<p> Clean, responsive design based in HTML and CSS.</p>
			</div>
			<div class="back">
				<h3>HTML/CSS</h3>
			</div>
		...
		<div class="servicesitem">
			<div class="front">
				<div data-icon="&#xe061;" class="icon"></div>
				<p> JQuery, ES6, and all the latest tools including Grunt, Gulp, Webpack, and Babel.</p>
			</div>
			<div class="back">
				<h3>Javascript</h3>
			</div>
		...
		<div class="servicesitem">
			<div class="front">
				<div data-icon="&#xe058;" class="icon"></div>
				<p>Node.js coupled with Express for the server side.</p>
			</div>
			<div class="back">
				<h3>Node.js</h3>
			</div>
	...
	<!-- Start Section Divider -->
	<div class="section divider" id="contactsection">
		<h2 id="servicestitle">Contact Me!</h2>
	...
	<div class="content contact">
		...
		<ul class="contacts">
			<li class="linkedin"><a href="https://www.linkedin.com/in/sara-cashman-510a301b" target="blank"><i class="fa fa-linkedin" aria-hidden="true" style:"font-size: 200%;"></i></a></li>
			<li class="github"><a href="https://github.com/smcashman" target="blank"><i class="fa fa-github" aria-hidden="true"></i></a></li>
			<li class="twitter"><a href="https://www.twitter.com/smargaretc" target ="blank"><i class="fa fa-twitter" aria-hidden="true"></i></a></li> 
		</ul>
		<!-- Start Main Paragraph -->
